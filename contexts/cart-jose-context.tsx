...
const CART_STORAGE_KEY = "cart_jose";

export function CartJoseProvider({ children }: { children: React.ReactNode }) {
...
export function useCartJose() {
  const context = useContext(CartContext);
  if (context === undefined) {
    throw new Error("useCartJose debe ser usado dentro de CartJoseProvider");
  }
  return context;
}
