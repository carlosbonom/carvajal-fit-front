  ...
  return (
    <>
      ...
      <ConfirmModal
        ...
        message={`¿Estás seguro de que deseas eliminar la categoría "${categoryToDelete?.name}"? Esta acción no se puede deshacer y los contenidos asociados perderán su categoría.`}
        type="danger"
