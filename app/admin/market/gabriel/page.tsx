...
export default function MarketGabrielPage() {
  ...
  const loadProducts = async () => {
    try {
      ...
      // const response = await getProducts("gabriel");
      ...
      setProducts([
        {
          id: "1",
          name: "Programa de Cardio Intensivo",
          description: "Rutina completa de cardio para quemar grasa",
          type: "digital",
          price: 14900,
          currency: "CLP",
          isActive: true,
        ...
        },
        {
          ...
          description: "PDF con información sobre suplementos deportivos",
          type: "pdf",
          price: 11900,
          currency: "CLP",
          isActive: true,
        ...
        {
          id: "3",
          name: "Gorra Carvajal Fit",
          description: "Gorra oficial con logo bordado",
          type: "merchandise",
          price: 12900,
          currency: "CLP",
          stock: 15,
        ...
        {
          id: "4",
          name: "Rutina de Fuerza Funcional",
          description: "Programa de 8 semanas para desarrollar fuerza",
          type: "digital",
          price: 17900,
          currency: "CLP",
          isActive: true,
