...
const videos: Video[] = [
  {
    ...
    duration: "45 min",
    description:
      "Introducción al programa de quema de grasa. Aprenderás los fundamentos del entrenamiento y cómo estructurar tus sesiones para maximizar la quema de grasa.",
  ...
  },
  {
    ...
    duration: "50 min",
    description:
      "Aumenta la intensidad de tus entrenamientos con rutinas de intensidad media diseñadas para acelerar tu metabolismo.",
    thumbnail: "/api/placeholder/800/450",
  },
  {
    id: "3",
    ...
    duration: "55 min",
    description:
      "Entrenamientos de alta intensidad que desafiarán tus límites y maximizarán la quema de grasa.",
    thumbnail: "/api/placeholder/800/450",
  },
  {
    id: "4",
    ...
    duration: "60 min",
    description:
      "Lleva tu entrenamiento al siguiente nivel con rutinas de máximo rendimiento para alcanzar tus objetivos.",
    thumbnail: "/api/placeholder/800/450",
  },
];

function BajarGrasaPageContent() {
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      >
                        <Play
                          ...
                          fill={
                            selectedVideo.id === video.id ? "white" : "none"
                          }
                        />
                      </div>
...
export default function BajarGrasaPage() {
  return (
    <Suspense fallback={<div className="min-h-screen bg-[#0b0b0b] text-white flex items-center justify-center">Cargando...</div>}>
      <BajarGrasaPageContent />
    </Suspense>
  );
}
