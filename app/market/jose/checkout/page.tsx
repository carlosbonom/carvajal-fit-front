...
export default function CheckoutJosePage() {
  ...
  const { items, removeItem, updateQuantity, clearCart, getTotal } = useCartJose();
  ...
  const handleCheckout = async () => {
    ...
    try {
      ...
      // clearCart();
      // router.push("/market/jose/checkout/success");
    } catch (error) {
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="max-w-4xl mx-auto">
          <h1 className="text-3xl font-bold text-gray-900 mb-8">Checkout - Market José</h1>
